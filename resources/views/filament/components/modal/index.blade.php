...
@php
    ...
    // Vesper: render a compact, centered confirmation modal when the modal is a
    // simple heading + footer (no custom header / body content) and not a slide-over.
    $isCompactConfirmationModal = (! $slideOver) && (! $header) && (! $hasContent) && $hasHeading && $hasFooter;
...
<div
    ...
    {{
        $attributes->class([
            ...
            'vs-confirmation-modal' => $isCompactConfirmationModal,
        ])
    }}
>
    <div
        ...
        <{{ filled($wireSubmitHandler) ? 'form' : 'div' }}
            ...
            {{
                ($extraModalWindowAttributeBag ?? new \Illuminate\View\ComponentAttributeBag)->class([
                    ...
                    'vs-confirmation-modal-window' => $isCompactConfirmationModal,
                ])
            }}
        >
            @if ($heading || $header)
                    ...
                    @else
                        <div
                            @class([
                                ...
                                'vs-confirmation-modal-actions' => $isCompactConfirmationModal,
                            ])
                        >
